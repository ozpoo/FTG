...
import {ecommerce_bag} from 'react-icons-kit/linea/ecommerce_bag'
...
class Layout extends React.Component {
  render() {
    ...
    <svg
      width="100%"
      height="100%"
      viewBox="0 0 1200 796.2"
      xmlns="http://www.w3.org/2000/svg"
      xmlnsXlink="http://www.w3.org/1999/xlink"
    >
    <path d="M923.5,306.8c11-5.6,19.3-9.4,27.2-14c47.1-27.6,97.3-47.8,150.8-58.5c22-4.4,44.6-5.5,66.9-8
    ...
    <path d="M177.3,497.4c-2,3.3-3.8,6-5.2,8.9c-6.8,13.6-13.4,27.2-20.1,40.8c-2.8,5.7-5.6,11.3-8.2,17
    ...
    <path d="M442.3,628.7c0.6-2.7,1.5-7.6,3-12.4c5.2-16.6,9.9-33.5,16.1-49.8c8.1-21.4,17.5-42.4,26.4-63.5
    ...
    return (
      <div>
        <ReactTooltip id="top" effect='solid' place={'top'} />
        <ReactTooltip id="topMint" className="customTip" effect='solid' place={'top'} />
        <ReactTooltip id="left" effect='solid' place={'left'} />
        <ReactTooltip id="right" effect='solid' place={'right'} />
        <Fade>
          <header>
            <div className="left">
              <div className="logo">
                <Link data-for="right" data-tip="Home" to={'/'}>
                  <SVG fill="#333" name="icon-1" />
                </Link>
              </div>
            </div>
            <div className="right">
              <p>
                <button data-for="left" data-tip="Menu" className="menuBtn"><Icon icon={arrows_plus} size={32} /></button>
              </p>
              <p>
                <button data-for="left" data-tip="View cart" className="snipBtn snipcart-checkout"><Icon icon={ecommerce_bag} size={26} /></button>
              </p>
            </div>
          </header>
        </Fade>
        ...
        <Fade>
          <footer>
            {/*
              <small>Made with</small><span className="mint"> &#10084; </span><small>by <a target="_blank" href="https://ericandren.com">Ozpoo</a></small>
            */}
          </footer>
        </Fade>
      </div>
